...
var Account = {
  apple: {},
  google: [Player.calbeec, Player.Mamair],
  node: {
    channelWindow: new Node.ViewNode(
      [
        new Node.BaseNode(706, 688, Color.orange),
        new Node.BaseNode(900, 89, Color.blueGrey),
      ],
      0,
      0,
      true
    ...
    accountWindow: new Node.ViewNode([
      new Node.BaseNode(526, 501, Color.black),
      new Node.BaseNode(523, 399, "#3b579d"),
    ]),
    google: new Node.BaseNode(639, 444),
    apple: new Node.BaseNode(625, 496),
    setting: new Node.BaseNode(1123, 719),
    settingWindow: new Node.ViewNode(
      [
        new Node.BaseNode(203, 81, Color.blueGrey),
        new Node.BaseNode(49, 618, "#4e4e4e"),
      ],
      0,
      0,
      true
    ...
    playerWindow: new Node.ViewNode(
      [
        new Node.BaseNode(1218, 173, "#f7e7c6"),
        new Node.BaseNode(1187, 172, "#e6c58c"),
      ],
      0,
      0,
      true
