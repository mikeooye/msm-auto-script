...
var identifiers = [
  new Node.BaseNode(229, 77, Color.blueGrey),
  new Node.BaseNode(934, 392, Color.yellow),
];
var expId = [
  new Node.BaseNode(853, 213, Color.blueGrey),
  new Node.BaseNode(568, 423, "#d7d7d6"),
  new Node.BaseNode(677, 570, Color.orange),
];
...
module.exports = {
  ...
  // 15 分钟选项
  option15: new Node.ViewNode(
    identifiers.concat([new Node.BaseNode(947, 394, Color.yellow)]),
    977,
    325,
    true,
    5000
  ...
  // 确认窗口
  confirmWindow: new Node.ViewNode(
    [
      new Node.BaseNode(821, 437, Color.yellow),
      new Node.BaseNode(545, 675, Color.blue),
      new Node.BaseNode(862, 680, Color.orange),
    ],
    0,
    0,
    true
  ...
  // 战斗窗口
  fightWindow: new Node.ViewNode(
    [
      new Node.BaseNode(159, 370, "#59b0a8"),
      new Node.BaseNode(1169, 31, Color.white),
    ],
    0,
    0,
    true,
  ...
  // 自动战斗窗口
  autoFightWindow: new Node.ViewNode(
    [
      new Node.BaseNode(525, 257, Color.yellow),
      new Node.BaseNode(646, 374, Color.yellow),
      new Node.BaseNode(550, 606, Color.orange),
    ],
    0,
    0,
    true,
  ...
  // 继续游戏窗口
  continueWindow: new Node.ViewNode(
    [
      new Node.BaseNode(515, 192, Color.orange),
      new Node.BaseNode(474, 676, Color.blue),
      new Node.BaseNode(718, 682, Color.teal),
    ],
    0,
    0,
    true
